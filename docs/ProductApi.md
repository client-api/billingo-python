...
with clientapi_billingo.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_billingo.ProductApi(api_client)
    product = clientapi_billingo.Product() # Product | Product object that you would like to store.
...
with clientapi_billingo.ApiClient(configuration) as api_client:
    ...
    api_instance = clientapi_billingo.ProductApi(api_client)
    id = 56 # int | 
    product = clientapi_billingo.Product() # Product | Product object that you would like to update.

...
import clientapi_billingo.models
from clientapi_billingo import rest
from clientapi_billingo.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(clientapi_billingo.models, klass)

...
class BankAccountList(BaseModel):
    """
    A object with a data property that contains an array of up to limit bank accounts. Each entry in the array is a separate bank account object. If no more bank accounts are available, the resulting array will be empty.  # noqa: E501
    """
    data: Optional[conlist(BankAccount)] = None

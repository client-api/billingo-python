...
class TaxNumber(BaseModel):
    ...
    result: Optional[CheckTaxNumberMessage] = None
    __properties = ["tax_number", "result"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaxNumber:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaxNumber:
        """Create an instance of TaxNumber from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaxNumber.parse_obj(obj)

        _obj = TaxNumber.parse_obj({

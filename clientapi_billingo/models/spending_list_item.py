...
class SpendingListItem(BaseModel):
    ...
    __properties = ["id", "organization_id", "category", "paid_at", "fulfillment_date", "partner", "invoice_number", "currency", "conversion_rate", "total_gross", "total_gross_local", "total_vat_amount", "total_vat_amount_local", "invoice_date", "due_date", "payment_method", "comment", "is_created_by_nav"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpendingListItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpendingListItem:
        """Create an instance of SpendingListItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpendingListItem.parse_obj(obj)

        _obj = SpendingListItem.parse_obj({
            "id": obj.get("id"),

...
class DocumentPublicUrl(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentPublicUrl:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentPublicUrl:
        """Create an instance of DocumentPublicUrl from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentPublicUrl.parse_obj(obj)

        _obj = DocumentPublicUrl.parse_obj({

...
from clientapi_billingo.models.document_block_list import DocumentBlockList  # noqa: E501
...
class TestDocumentBlockList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DocumentBlockList:
        ...
        """
        model = DocumentBlockList()  # noqa: E501
        if include_optional:
            return DocumentBlockList(
                data = [
                    clientapi_billingo.models.document_block.DocumentBlock(
                        id = 56, 
                        name = '', 
                        prefix = '', 
                        custom_field1 = '', 

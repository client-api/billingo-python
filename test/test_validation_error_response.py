...
from clientapi_billingo.models.validation_error_response import ValidationErrorResponse  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ValidationErrorResponse:
        ...
        if include_optional:
            return ValidationErrorResponse(
                message = '',
                errors = [
                    clientapi_billingo.models.validation_error.ValidationError(
                        field = '', 
                        message = '', )
                    ]
            )
